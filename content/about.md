...
VirtualHub DOSBox-X is a static site and it is fast. While [VirtualHub](https://virtualhub.eu.org) is built using [Jekyll](https://jekyllrb.com/), this site is built using [Hugo](https://gohugo.io/).
